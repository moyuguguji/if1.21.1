...
- “展示”指
 - 在不发布二进制文件、资源文件或源代码的前提下使用《Infinity-reborn-nf》，比如YouTube或Bilibili上的游戏或介绍视频。
...
- 扩展条款
 - 本许可条款适用于《Infinity-reborn-nf》、Github仓库中的所有其他代码、资源文件或二进制文件，除非另有说明。

3.如果您想使用或修改原创代码内容

- 您有权利使用或修改代码内容并用于自己的项目。
- 但您的项目必须是开源的，且注明“引用/修改于《Infinity-reborn-nf》模组包”，并附上原发布地址的链接。
...
5.如果您想架设基于《Infinity-reborn-nf》的服务器

- 您可以自由架设“私人服务器”与“非商业”的“公共服务器”。
 - 若您想要建设“商业服务器”，必须获得制作团队许可。

6.如果您想“展示”《Infinity-reborn-nf》

- 您不能声称为《Infinity-reborn-nf》的开发者
