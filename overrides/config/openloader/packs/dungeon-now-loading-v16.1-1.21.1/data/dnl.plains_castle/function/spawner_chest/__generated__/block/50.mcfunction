...
execute align xyz positioned ~-10 ~-1.1 ~-10 unless entity @e[type=minecraft:marker,tag=dnl.spawner,dx=20,dy=9,dz=20] at @s if entity @a[distance=..10] run function dnl.plains_castle:spawner_chest/__generated__/block/55