...
execute align xyz positioned ~-1 ~ ~-1 unless entity @e[type=minecraft:item_frame,nbt={Item:{components:{"minecraft:custom_data":{"dnl.material":1b}}}},tag=!dnl.used,dx=2,dy=2,dz=2] run function dnl.plains_castle:monolith/__generated__/execute/117
