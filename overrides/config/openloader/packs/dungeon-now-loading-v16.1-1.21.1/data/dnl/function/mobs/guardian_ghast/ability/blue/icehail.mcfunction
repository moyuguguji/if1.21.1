...
execute at @e[type=minecraft:area_effect_cloud,tag=dnl.hail] run summon snowball ~ 160 ~ {Tags:["dnl.mob","dnl.guardian_ghast","dnl.projectile","dnl.hail"],Item:{id:"minecraft:blue_ice",count:1}}
