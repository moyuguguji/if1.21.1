...
execute at @s[scores={dnl.subvariable=1..60}] run particle minecraft:block{block_state:{Name:"minecraft:cobweb"}} ~ ~ ~ 0.5 0.5 0.5 1 20

effect give @s[scores={dnl.subvariable=1}] minecraft:slowness 4 100 true
execute at @s[scores={dnl.subvariable=60}] run particle minecraft:block{block_state:{Name:"minecraft:cobweb"}} ~ ~ ~ 1 1 1 1 50
execute at @s[tag=phase1,tag=!phase2,scores={dnl.subvariable=60}] run fill ~-1 ~-1 ~-1 ~1 ~1 ~1 minecraft:cobweb replace minecraft:air

execute at @s[scores={dnl.subvariable=60}] run particle minecraft:block{block_state:{Name:"minecraft:cobweb"}} ~ ~ ~ 2 2 2 1 50
...
# Poison Aura #
execute at @s[tag=dnl.poison_aura,scores={dnl.variable=120..}] run particle minecraft:item{item:{id:"minecraft:green_dye",count:1}} ~ ~ ~ 0.5 0.5 0.5 0.00001 20
effect give @s[tag=dnl.poison_aura,scores={dnl.variable=120}] minecraft:slowness 3 100 true
execute at @s[tag=dnl.poison_aura,scores={dnl.variable=200}] run summon area_effect_cloud ~ ~ ~ {Radius:3f,Duration:40,Age:40,WaitTime:40,Color:5149489,custom_effects:[{id:"minecraft:poison",amplifier:1,duration:40}]}
tag @s[tag=dnl.poison_aura,scores={dnl.variable=200}] remove dnl.poison_aura

# Web Armor #
execute at @s[tag=dnl.web_armor,scores={dnl.variable=120..}] run particle minecraft:item{item:{id:"minecraft:string",count:1}} ~ ~ ~ 0.2 0.2 0.2 0.00001 20
effect give @s[tag=dnl.poison_aura,scores={dnl.variable=120}] minecraft:slowness 3 100 true
