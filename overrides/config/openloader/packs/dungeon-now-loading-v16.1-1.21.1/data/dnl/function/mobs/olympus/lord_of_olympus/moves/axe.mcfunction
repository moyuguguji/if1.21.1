...
execute if score @s dnl.timer matches 1 run data merge entity @s {Attributes:[{id:"minecraft:generic.knockback_resistance",base:1.0d}]}
execute if score @s dnl.timer matches 1..40 run particle minecraft:block{block_state:{Name:"minecraft:dirt"}} ~ ~ ~ 0.2 0 0.2 0.1 10 normal
execute if score @s dnl.timer matches 40 run effect give @s minecraft:speed 3 2 true
execute if score @s dnl.timer matches 40 run data merge entity @s {Attributes:[{id:"minecraft:generic.knockback_resistance",base:0.0d}]}
