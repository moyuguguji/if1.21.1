...
execute if entity @a[nbt={SelectedItem:{id:"minecraft:bow",tag:{display:{Name:'{"text":"Broken Bow","color":"gold","italic":false}'}}}}] at @s run summon item ~ ~ ~ {Item:{id:"minecraft:bone",count:10,tag:{display:{Name:'{"text":"Bone","color":"gold","italic":false}'}}}}
...
execute at @s run item replace entity @a[distance=..64,nbt={Inventory:[{Slot:-106,id:"minecraft:bow",tag:{display:{Name:'{"text":"Broken Bow","color":"gold","italic":false}'}}}]}] weapon.offhand with minecraft:bow{display:{Name:'{"text":"Hunter\\"s Bow","color":"gold","italic":false}'},Unbreakable:1b,Enchantments:[{}]}
