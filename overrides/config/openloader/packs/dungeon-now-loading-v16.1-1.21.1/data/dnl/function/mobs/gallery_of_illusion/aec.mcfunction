execute at @s[tag=pillager_jokey] run summon spider ~ ~ ~ {PersistenceRequired:1b,Health:20f,Tags:["illusioned_gallery"],Passengers:[{id:"minecraft:pillager",PersistenceRequired:1b,Health:31f,Tags:["noai","illusioned_gallery"],HandItems:[{id:"minecraft:crossbow",count:1,tag:{Enchantments:[{id:"minecraft:quick_charge",lvl:1s}]}},{}],Attributes:[{id:"minecraft:max_health",base:31}]}],Attributes:[{id:"minecraft:max_health",base:20}]}
kill @s[tag=pillager_jokey]

execute at @s[tag=evoker_ravager] run summon ravager ~ ~ ~ {PersistenceRequired:1b,Health:120f,Tags:["illusioned_gallery"],Passengers:[{id:"minecraft:evoker",PersistenceRequired:1b,Health:30f,Tags:["noai","illusioned_gallery"],Attributes:[{id:"minecraft:max_health",base:30}]}],Attributes:[{id:"minecraft:max_health",base:120}]}
kill @s[tag=evoker_ravager]

execute at @s[tag=jukebox] if block ~ ~-1 ~ minecraft:jukebox{RecordItem:{id:"minecraft:music_disc_cat",count:1,tag:{display:{Name:'{"italic":false,"color":"gold","text":"Illusioner"s Disc"}'}}}} run scoreboard players add @s dnl.variable 1
execute at @s[tag=jukebox] unless block ~ ~-1 ~ minecraft:jukebox{RecordItem:{id:"minecraft:music_disc_cat",count:1,tag:{display:{Name:'{"italic":false,"color":"gold","text":"Illusioner"s Disc"}'}}}} run scoreboard players reset @s dnl.variable
