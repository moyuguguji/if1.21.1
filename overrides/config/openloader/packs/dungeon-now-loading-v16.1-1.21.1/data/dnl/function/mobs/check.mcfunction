...
execute as @e[type=minecraft:generic.armor_stand,tag=chain_moving_armor] at @s if entity @a[distance=..5,gamemode=survival] run function dnl:mobs/gallery_of_illusion/chain_moving_armor
execute as @e[type=minecraft:generic.armor_stand,tag=iron_moving_armor] at @s if entity @a[distance=..5,gamemode=survival] run function dnl:mobs/gallery_of_illusion/iron_moving_armor
execute as @e[type=minecraft:generic.armor_stand,tag=diamond_moving_armor] at @s if entity @a[distance=..5,gamemode=survival] run function dnl:mobs/gallery_of_illusion/diamond_moving_armor
