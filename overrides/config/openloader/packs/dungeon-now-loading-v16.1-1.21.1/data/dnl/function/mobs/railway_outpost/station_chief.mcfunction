...
execute at @s[scores={dnl.variable=60},tag=!phase_change] run summon ravager ~ ~ ~ {Health:180f,Invulnerable:1b,DeathLootTable:"dnl:structures/railway_outpost/mobs/ravager",PersistenceRequired:1b,Tags:["station_chief_ravager"],Passengers:[{id:"minecraft:pillager",Glowing:1b,DeathLootTable:"dnl:structures/railway_outpost/mobs/station_chief",PersistenceRequired:1b,Tags:["phase_change","station_chief","pillager_persistence_true","railway_boss"],CustomName:'{"text":"Station Chief","color":"red","bold":true,"italic":false}',HandItems:[{id:"minecraft:crossbow",count:1,components:{"minecraft:charged_projectiles":[{id:"minecraft:tipped_arrow",count:1,components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:poison",amplifier:3,duration:60}],custom_color:5149489}}},{id:"minecraft:tipped_arrow",count:1,components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:poison",amplifier:3,duration:60}],custom_color:5149489}}},{id:"minecraft:tipped_arrow",count:1,components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:poison",amplifier:3,duration:60}],custom_color:5149489}}}]}},{}],HandDropChances:[0.000F,0.085F],Health:180f,Attributes:[{id:"minecraft:generic.max_health",base:180}]}]}
execute as @e[type=ravager,tag=station_chief_ravager,limit=1,sort=nearest] run attribute @s minecraft:generic.max_health base set 180
execute as @e[type=ravager,tag=station_chief_ravager,limit=1,sort=nearest] run data merge entity @s {Health:180f}
execute as @e[type=pillager,tag=station_chief,tag=railway_boss,limit=1,sort=nearest] run attribute @s minecraft:generic.max_health base set 180
execute as @e[type=pillager,tag=station_chief,tag=railway_boss,limit=1,sort=nearest] run data merge entity @s {Health:180f}
