...
execute if score @s dnl.timer matches 1 run data merge entity @s {HandItems:[{id:"minecraft:potion",count:1,components:{"minecraft:potion_contents":{"potion":"minecraft:instant_damage"}}},{}]}
